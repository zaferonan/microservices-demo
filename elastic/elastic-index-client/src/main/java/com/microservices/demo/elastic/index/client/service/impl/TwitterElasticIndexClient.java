...
/*
 * Elastic Search save Index First way
 * **It is conditionally uses if elastic-config.is-repository configuration is false
 *   Otherwise TwitterElasticRepositoryIndexClient uses as IndexClient
 *
 *
 * */
